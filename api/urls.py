...
from api.views import StudentProfileViewSet, CourseViewSet, StudentCourseRegistrationViewSet
...
router.register('users', StudentProfileViewSet, basename='api_users')
